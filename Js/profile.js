    ...
    (a += `<div class="container">
        <div class=" w-1/2 mx-auto bg-white user__card hover:shadow-lg rounded-lg overflow-hidden">
            <div class="sm:flex sm:items-center px-6 py-5">
                ...
                <div class="mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
                    <div class="">
                        <button class=" short__list px-3 py-2 outline-none rounded-full inline-flex items-center font-semibold leading-normal text-xs" onClick='shortlist()'>
                    ...
                    <div class="my-2">
                        <button class=" favorite px-3 outline-none py-2 rounded-full inline-flex items-center font-semibold leading-normal text-xs" onClick='favorite()'>
                    ...
                    <div class="my-2">
                        <button class="reject px-4 outline-none py-2 rounded-full inline-flex items-center font-semibold leading-normal text-xs" onClick='reject()'>
