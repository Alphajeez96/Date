...
const mountchats = () => {
    ...
    suggestions.forEach(e => {
        ...
        <div class="  w-3/4 mx-4 bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="sm:flex sm:items-center px-6 py-5">
            <img class="block mx-auto sm:mx-0 sm:flex-shrink-0 rounded-full" src='${e.src}' alt="Woman's Face">
            <div class="mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
                <p class="text-xl  leading-tight">${e.name}</p>
                <p class="text-sm pt-2 leading-tight text-gray-600">${e.address}</p>
                <p class="text-sm leading-tight pt-2 ">${e.description}</p>
            </div>
            <div class="mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
            </div>
        </div>
